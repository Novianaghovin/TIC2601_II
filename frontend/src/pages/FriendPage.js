...
function FriendPage() {
    ...
    const handleAccept = async (requesterId) => {
        try {
            await axios.post('/friends/accept', { requester_id: requesterId });
    ...
    const handleReject = async (requesterId) => {
        try {
            await axios.post('/friends/reject', { requester_id: requesterId });
    ...
    const handleUnfriend = async (friendId) => {
        try {
            await axios.post('/friends/break', { friend_id: friendId });
