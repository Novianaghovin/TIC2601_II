...
const ProfileSideBar = ({ avatarUrl, setAvatarUrl }) => {
  ...
  return (
    <div className="card">
      <div className="card-body user-profile sidebar-text"> {/* Apply sidebar-text class for consistent styling */}
        {error ? (
          ...
          <>
            <div className="avatar-container" style={{ position: "relative" }}>
              <img
                ...
                onError={(e) => { 
                  e.target.src = '/user_uploads/default.png';
                }}
            ...
            <p className="user-info">Gender: {userData.gender || 'Not specified'}</p>
            <p className="user-info">Age: {calculateAge(userData.dob)}</p>
          </>
        )}
      </div>
    </div>
